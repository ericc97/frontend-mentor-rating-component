...
function App() {
  ...
  return (
    ...
    {!isSubmitted && <div className="wrapper">
      <img src={star} alt='' className='bg-gray-700 p-2 rounded-full'></img>
...
const ThankYou = ({ items, setIsSubmitted }) => {
  return (
    <div className='wrapper'>
      <img className='block mx-auto mb-5' src={thanks} alt='hi'></img>
      <div className='flex items-center justify-center'>
        <p className='p-rating bg-gray-700 rounded-full text-center text-small px-4 pt-1'>You selected {items} out of 5</p>
      </div>
      <h2 h2 className='text-gray-100 text-3xl my-6 text-center'>Thank You</h2>
